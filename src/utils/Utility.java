...
public class Utility {
    ...
    public enum TreasureName{CHEST, CRYPT_OF_THE_KNIGHT, ENCHANTED_MEADOW, MOULDY_SKELETON,
    	REMAINS_OF_THIEF, TOADSTOOL_CIRCLE, BATTLE_BRACELETS, BEJEWELED_DWARF_VEST, BELT_OF_STRENGTH, BLASTED_JEWEL,
    	...
    	HIDDEN_RING, IMPERIAL_TABARD, LUCKY_CHARM, MAGIC_WAND, REGENT_OF_JEWELS, SACRED_GRAIL, TIMELESS_JEWE, LEAGUE_BOOTS_7, ALCHEMISTS_MIXTURE,
    	AMULET, ANCIENT_TELESCOPE, BEAST_PIPES, BLACK_BOOK,
